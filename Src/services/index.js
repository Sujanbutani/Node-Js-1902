...
module.exports.hotelService=require("./hotel.services");
module.exports.travelService=require("./travel.services");
module.exports.movieService=require("./movie.services");
module.exports.musicService=require("./music.services");
module.exports.pharmacyService=require("./pharmacy.services");
